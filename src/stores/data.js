export default [
    {
        ...
        prompt: `(((masterpiece))), (((highres))), (((ultra-detailed))), (((illustration))), (((intricate))), (((extremely detailed))), (((soft lighting))), (((soft light))), (((soft focus))), ((1girl)), (((short hair))), (((black hair))), (((braid one's hair))), (((wearing a simple choker))), (((white coat))), (((black shirt))), ((small round breasts)), ((light brown eyes)), (((right pupil))), (((left pupil))), ((blushing)), ((smiling)), ((beautiful face)), ((looking at viewer)), white background, viewfinder, (((masterpiece))), (((highres))), (((ultra-detailed))), (((illustration))), (((intricate))), (((extremely detailed))), (((soft lighting))), (((soft light))), (((soft focus))), ((1girl)), (((short hair))), (((black hair))), (((braid one's hair))), (((wearing a simple choker))), (((white coat))), (((black shirt))), ((small round breasts)), ((light brown eyes)), (((right pupil))), (((left pupil))), ((blushing)), ((smiling)), ((beautiful face)), ((looking at viewer)), white background, viewfinder`,
        negative: `lowres, bad anatomy, bad hands, mutated hand, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name, out of focus, glowing eyes, (((multiple views))), (((bad proportions))), (((multiple legs))), (((multiple arms))), 3D, bad_prompt, (worst quality:2.0), (low quality:2.0), inaccurate limb, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name, tall, (painting by bad-artist-anime:0.9), (painting by bad-artist:0.9), bad-prompt:0.5, watermark, text, error, blurry, jpeg artifacts, cropped, normal quality, jpeg artifacts, signature, watermark, username, artist name, (worst quality, low quality:1.4), bad anatomy, low quality lowres, low quality lowres low polygon 3D game, low quality lowres,lowres, bad anatomy, bad hands, mutated hand, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name, out of focus, glowing eyes, (((multiple views))), (((bad proportions))), (((multiple legs))), (((multiple arms))), 3D, bad_prompt, (worst quality:2.0), (low quality:2.0), inaccurate limb, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, artist name, tall, (painting by bad-artist-anime:0.9), (painting by bad-artist:0.9), bad-prompt:0.5, watermark, text, error, blurry, jpeg artifacts, cropped, normal quality, jpeg artifacts, signature, watermark, username, artist name, (worst quality, low quality:1.4), bad anatomy, low quality lowres, low quality lowres low polygon 3D game, low quality lowres `, // Array,
